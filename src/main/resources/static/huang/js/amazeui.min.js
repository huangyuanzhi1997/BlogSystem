    ...
    return function t(e, i, n) {
        ...
        1: [function (t, e, i) {
            ...
            o.DEFAULTS = {
                ...
                var i = this.$element, o = "disabled", a = i.data(), r = this.options,
                    l = i.is("input") ? "val" : "html", c = "am-btn-" + t + " " + r.disabledClassName;
            ...
            a.DEFAULTS = {toggle: !0}, a.prototype.open = function () {
                ...
                var e, i = s(this), a = o.utils.options(i.attr("data-am-collapse")),
                    ...
                    l = s(r), c = l.data("amui.collapse"), u = c ? "toggle" : a, h = a.parent, d = h && s(h);
            ...
            var r = {
                ...
                headTemplate: '<thead><tr class="am-datepicker-header"><th class="am-datepicker-prev"><img class="am-datepicker-prev-icon"></img></th><th colspan="5" class="am-datepicker-switch"><div class="am-datepicker-select"></div></th><th class="am-datepicker-next"><img class="am-datepicker-next-icon"></img></th></tr></thead>',
            ...
            n.flexslider = function (t, e) {
                ...
                var s, o = i.vars.namespace,
                    ...
                    h = i.vars.reverse, d = i.vars.itemWidth > 0, p = "fade" === i.vars.animation,
                    m = "" !== i.vars.asNavFor, f = {}, v = !0;
                    ...
                    init: function () {
                        ...
                        setup: function () {
                            ...
                            if (i.controlNavScaffold = n('<ol class="' + o + "control-nav " + o + s + '"></ol>'), i.pagingCount > 1) for (var r = 0; r < i.pagingCount; r++) {
                                ...
                                i.controlNavScaffold.append("<li>" + t + "<img></img></li>"), a++
                            }
            ...
            "use strict";
            var n = window.jQuery, s = t(2), o = t(14), a = t(30), r = s.support.animation, l = s.support.transition,
                c = function (t, e) {
            ...
            c.DEFAULTS = {
                ...
                var t = this, e = this.options, i = this.$pureview, s = n([]), o = n([]), a = this.$images,
                    r = a.length;
                ...
                var e = this.options, i = this.$slides, o = i.index(t), a = t.data("title") || "",
            ...
            o.DEFAULTS = {
                ...
                searchBox: !1,
                tpl: '<div class="am-selected am-dropdown <%= dropUp ? \'am-dropdown-up\': \'\' %>" id="<%= id %>" data-am-dropdown>  <button type="button" class="am-selected-btn am-btn am-dropdown-toggle">    <span class="am-selected-status am-fl"></span>    <img class="am-selected-icon am-icon-caret-<%= dropUp ? \'up\' : \'down\' %>"></img>  </button>  <div class="am-selected-content am-dropdown-content">    <h2 class="am-selected-header"><span class="am-icon-chevron-left">\u8fd4\u56de</span></h2>   <% if (searchBox) { %>   <div class="am-selected-search">     <input autocomplete="off" class="am-form-field am-input-sm" />   </div>   <% } %>    <ul class="am-selected-list">      <% for (var img = 0; img < options.length; img++) { %>       <% var option = options[img] %>       <% if (option.header) { %>  <li data-group="<%= option.group %>" class="am-selected-list-header">       <%= option.text %></li>       <% } else { %>       <li class="<%= option.classNames%>"          data-index="<%= option.index %>"          data-group="<%= option.group || 0 %>"          data-value="<%= option.value %>" >         <span class="am-selected-text"><%= option.text %></span>         <img class="am-icon-check"></img></li>      <% } %>      <% } %>    </ul>    <div class="am-selected-hint"></div>  </div></div>',
                listTpl: '<% for (var img = 0; img < options.length; img++) { %>       <% var option = options[img] %>       <% if (option.header) { %>  <li data-group="<%= option.group %>" class="am-selected-list-header">       <%= option.text %></li>       <% } else { %>       <li class="<%= option.classNames %>"          data-index="<%= option.index %>"          data-group="<%= option.group || 0 %>"          data-value="<%= option.value %>" >         <span class="am-selected-text"><%= option.text %></span>         <img class="am-icon-check"></img></li>      <% } %>      <% } %>'
            ...
            l.DEFAULTS = {
                ...
                via: "Amaze UI",
                tpl: '<div class="am-share am-modal-actions" id="<%= id %>"><h3 class="am-share-title"><%= title %></h3><ul class="am-share-sns am-avg-sm-3"><% for(var img = 0; img < sns.length; img++) {%><li><a href="<%= sns[img].shareUrl %>" data-am-share-to="<%= sns[img].id %>" ><img class="am-icon-<%= sns[img].icon %>"></img><span><%= sns[img].title %></span></a></li><% } %></ul><div class="am-share-footer"><button class="am-btn am-btn-jantent am-btn-block" data-am-share-close><%= cancel %></button></div></div>'
            }, l.SNS = {
                weibo: {
                    title: "\u65b0\u6d6a\u5fae\u535a",
            ...
            var n = window.jQuery, s = t(2), o = s.utils.rAF, a = s.utils.cancelAF, r = !1, l = function (t, e) {
                ...
                e = e || {};
                var u, h, d, p = n(t), m = parseInt(e.position) || l.DEFAULTS.position, f = p.scrollTop(), v = f,
                    g = m - f, w = e.speed || Math.min(750, Math.min(1500, Math.abs(f - m))), y = function () {
                        s()
                    };
                if (!r && 0 !== g) {
            ...
            var s = window.jQuery, o = t(2), a = t(30), r = o.support.transition, l = o.support.animation,
                c = function (t, e) {
            ...
            o.DEFAULTS = {
                ...
                checkboxTpl: '<span class="am-ucheck-icons"><img class="am-icon-unchecked"></img><img class="am-icon-checked"></img></span>',
                radioTpl: '<span class="am-ucheck-icons"><img class="am-icon-unchecked"></img><img class="am-icon-checked"></img></span>'
            }, o.prototype.init = function () {
            ...
            o.DEFAULTS = {
                ...
                var d = void 0 !== o.attr("required") && "false" !== o.attr("required"),
                    p = parseInt(o.attr("maxlength"), 10), m = parseInt(o.attr("minlength"), 10),
                    f = Number(o.attr("min")), v = Number(o.attr("max")),
            ...
            var rt = window.jQuery, lt = t(2), ct = ["", "webkit", "moz", "MS", "ms", "o"],
                ut = document.createElement("div"), ht = "function", dt = Math.round, pt = Math.abs, mt = Date.now,
                ft = 1, vt = /mobile|tablet|ip(ad|hone|od)|android/i, gt = "ontouchstart" in window,
                wt = void 0 !== b(window, "PointerEvent"), yt = gt && vt.test(navigator.userAgent), bt = "touch",
                Tt = "pen", xt = "mouse", Ct = "kinect", Et = 25, St = 1, kt = 2, Dt = 4, Ft = 8, At = 1, Mt = 2,
                $t = 4, Pt = 8, Nt = 16, It = Mt | $t, Ot = Pt | Nt, Lt = It | Ot, zt = ["x", "y"],
                _t = ["clientX", "clientY"];
            C.prototype = {
                handler: function () {
                }, init: function () {
            ...
            var jt = {touchstart: St, touchmove: kt, touchend: Dt, touchcancel: Ft}, Xt = "touchstart",
            ...
            var Gt = b(ut.style, "touchAction"), Jt = void 0 !== Gt, Kt = "compute", te = "auto", ee = "manipulation",
            ...
            function s() {
                var t = document.querySelector(".am-map"), e = 116.331398, i = 39.897445,
                    n = t.getAttribute("data-name"), s = t.getAttribute("data-address"),
                    o = t.getAttribute("data-longitude") || e, a = t.getAttribute("data-latitude") || i,
                    r = t.getAttribute("data-setZoom") || 17, l = t.getAttribute("data-icon"),
                    c = new BMap.Map("bd-map"), u = new BMap.Point(o, a);
                ...
                var d = {width: 200, title: n}, p = new BMap.InfoWindow("\u5730\u5740\uff1a" + s, d),
                    m = new BMap.Geocoder;
            ...
            function n() {
                ...
                if (n.length) {
                    var l = s(window), c = s("body"), u = n.find(".am-navbar-nav"), h = n.find("li"), d = h.length,
                        p = u.attr("class") && parseInt(u.attr("class").match(/am-avg-sm-(\d+)/)[1]) || 3, m = 60,
                        f = 16, v = h.filter("[data-am-navbar-share]"), g = h.filter("[data-am-navbar-qrcode]"),
                        w = "am-active",
