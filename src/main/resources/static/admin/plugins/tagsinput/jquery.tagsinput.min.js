(function (a) {
    ...
    a.fn.tagsInput = function (d) {
        ...
        this.each(function () {
            ...
            if (e.interactive) {
                g = g + '<input id="' + d + '_tag" value="" data-jantent="' + e.defaultText + '" />'
            }
            ...
            if (e.interactive) {
                a(f.fake_input).val(a(f.fake_input).attr("data-jantent"));
                ...
                a(f.fake_input).bind("focus", f, function (b) {
                    if (a(b.data.fake_input).val() == a(b.data.fake_input).attr("data-jantent")) {
                ...
                if (e.autocomplete_url != undefined) {
                    ...
                    a(f.fake_input).bind("blur", f, function (b) {
                        var c = a(this).attr("data-jantent");
                        if (a(b.data.fake_input).val() != "" && a(b.data.fake_input).val() != c) {
                            ...
                            a(b.data.fake_input).val(a(b.data.fake_input).attr("data-jantent"));
