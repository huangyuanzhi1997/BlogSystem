!function ($) {
    ...
    var MultiSelect = function (element, options) {
        this.options = options, this.$element = $(element), this.$container = $("<div/>", {"class": "ms-container"}), this.$selectableContainer = $("<div/>", {"class": "ms-selectable"}), this.$selectionContainer = $("<div/>", {"class": "ms-selection"}), this.$selectableUl = $("<ul/>", {
            "class": "ms-list",
            tabindex: "-1"
        }), this.$selectionUl = $("<ul/>", {
            "class": "ms-list",
    ...
    MultiSelect.prototype = {
        constructor: MultiSelect, init: function () {
